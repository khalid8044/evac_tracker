...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    evacTrackerAuthUserSubject.add(
      EvacTrackerAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<EvacTrackerAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  EvacTrackerAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = EvacTrackerAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    evacTrackerAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
EvacTrackerAuthUser? currentUser;

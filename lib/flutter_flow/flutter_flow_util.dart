...
T? castToType<T>(dynamic value) {
  ...
  if (T == String) {
    // Handle cases where value needs to be converted to String
    return value.toString() as T;
  }

  switch (T) {
    case const (double):
      // Handle double values, even if they're stored as int
      if (value is int) {
    ...
    case const (int):
      // Handle int values, including cases where it's a double with no decimal part

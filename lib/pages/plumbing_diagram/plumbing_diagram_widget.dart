...
import 'plumbing_diagram_model.dart';
export 'plumbing_diagram_model.dart';
import 'package:widget_zoom/widget_zoom.dart';

class PlumbingDiagramWidget extends StatefulWidget {
  const PlumbingDiagramWidget({
    super.key,
  ...
  @override
  State<PlumbingDiagramWidget> createState() => _PlumbingDiagramWidgetState();
}

class _PlumbingDiagramWidgetState extends State<PlumbingDiagramWidget>
    with TickerProviderStateMixin {
  late PlumbingDiagramModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlumbingDiagramModel());

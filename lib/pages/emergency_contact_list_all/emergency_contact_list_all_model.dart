...
import 'emergency_contact_list_all_widget.dart'
    show EmergencyContactListAllWidget;

import 'package:flutter/material.dart';


class EmergencyContactListAllModel
    extends FlutterFlowModel<EmergencyContactListAllWidget> {
  ...
  // Stores action output result for [Backend Call - API (getECL)] action in ListTile widget.
  ApiCallResponse? eclResult;
  // Stores action output result for [Backend Call - API (getECL)] action in ListTile widget.
  ApiCallResponse? eclResultCopy;

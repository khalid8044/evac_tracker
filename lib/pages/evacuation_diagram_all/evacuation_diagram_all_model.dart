...
import 'evacuation_diagram_all_widget.dart' show EvacuationDiagramAllWidget;

import 'package:flutter/material.dart';
class EvacuationDiagramAllModel
    extends FlutterFlowModel<EvacuationDiagramAllWidget> {
  ...
  // Stores action output result for [Backend Call - API (evacDiagramByID)] action in ListTile widget.
  ApiCallResponse? apiResultlne;
  // Stores action output result for [Backend Call - API (evacDiagramByID)] action in ListTile widget.
  ApiCallResponse? apiResultlneCopy;

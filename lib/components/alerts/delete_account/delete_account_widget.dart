...
class _DeleteAccountWidgetState extends State<DeleteAccountWidget>
  ...
  void initState() {
    ...
    //_model.timerController = FlutterFlowTimerController(StopWatchTimer());
                                          ...
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 0.0, 0.0, 10.0),
                                            child: Text(
                                              'Please check your registered email address for verification code.',
                                                      ...
                                                      FFAppState()
                                                          ...
                                                          AuthenticationStruct
                                                              .fromSerializableMap(
                                                                  jsonDecode(
                                                                      '{}'));
                                                      FFAppState().qrBuilding =
                                                          BuildingStruct
                                                              .fromSerializableMap(
                                                                  jsonDecode(
                                                                      '{\"buildingID\":\"1\",\"FloorID\":\"1\",\"roomID\":\"1\"}'));
                                                      FFAppState().userData =
                                                          null;
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 20.0),
                                    child: Text(
                                      'This will delete all your information and added addresses. No further emergency alerts will be delivered to you.',
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                        ...
                                        onPressed: () async {
                                          _model.apiResultmyn =
                                              await EvacProjGroup
                                                  ...
                                                  .call(
                                            email:
                                                FFAppState().user.emailAddress,
                                          );

                                          if ((_model.apiResultmyn?.succeeded ??
                                              true)) {
                                            setState(() {
                                              _model.timerController
                                                  .onResetTimer();

...
import 'add_building_model.dart';
export 'add_building_model.dart';

class AddBuildingWidget extends StatefulWidget {
  const AddBuildingWidget({super.key});

  @override
  State<AddBuildingWidget> createState() => _AddBuildingWidgetState();
}

class _AddBuildingWidgetState extends State<AddBuildingWidget>
    with TickerProviderStateMixin {
  late AddBuildingModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context, () => AddBuildingModel());

    _model.swContractorValue = false;
    _model.swPermTempValue = false;
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Switch.adaptive(
                                        value: _model.swContractorValue!,
                                        onChanged: (newValue) async {
                                          setState(() => _model
                                              .swContractorValue = newValue);
                                        },
                                        activeThumbColor:
                                            FlutterFlowTheme.of(context)
                                                .secondaryText,
                                  ...
                                  if (_model.swContractorValue ?? true)
                                    Container(
                                      decoration: BoxDecoration(),
                                      child: SingleChildScrollView(
                                        primary: false,
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            if (_model.swPermTempValue ?? true)
                                              Form(
                                                key: _model.formKey1,
                                                autovalidateMode:
                                                    AutovalidateMode.disabled,
                                                        ...
                                                        Padding(
                                                          ...
                                                          child:
                                                            ...
                                                            onPressed:
                                                              ...
                                                              setState(() {
                                                                _model.timeOutVisitorTextController
                                                                        ?.text =
                                                                    dateTimeFormat(
                                                                  "yyyy-MM-dd HH:mm:ss",
                                                                  _model
                                              ...
                                              if (_model.swPermTempValue!) {
                                                ...
                                                if ((_model.apiResultog2
                                                  ...
                                                  ScaffoldMessenger.of(context)
                                                    ...
                                                    SnackBar(
                                                      content: Text(
                                                        'User added as Temp Contractor until ${_model.timeOutVisitorTextController.text}',
                                                        style: TextStyle(
                                                          color: FlutterFlowTheme
                                                                  .of(context)
                                                              .primaryText,

...
import 'assembly_area_all_model.dart';
import 'assembly_area_provider.dart';
export 'assembly_area_all_model.dart';

class AssemblyAreaAllWidget extends StatefulWidget {
  const AssemblyAreaAllWidget({super.key});

  @override
  State<AssemblyAreaAllWidget> createState() => _AssemblyAreaAllWidgetState();
}

class _AssemblyAreaAllWidgetState extends State<AssemblyAreaAllWidget> {
  late AssemblyAreaAllModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AssemblyAreaAllModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      final provider =
          Provider.of<AssemblyAreaProvider>(context, listen: false);
                      ...
                      child: Material(
                        ...
                        child: SafeArea(
                          child: Container(
                            ...
                            child: Consumer<AssemblyAreaProvider>(
                                                          ...
                                                          itemBuilder:
                                                            ...
                                                            return Padding(
                                                              ...
                                                              child: InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  provider.getAssemblyAreaPermanent(
                                                                      provider.addressesResident[
                                                                          index],
                                                                      context);
                                                                },
                                                          ...
                                                          itemBuilder:
                                                            ...
                                                            return Padding(
                                                              ...
                                                              child: InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  provider.getAssemblyAreaForContractor(
                                                                      provider.addressesPermContractor[
                                                                          index],
                                                                      context);
                                                                },
...
/*
 onTap: () async {
                                                                _model.apiResultxknCopy =
                                                                    await EvacProjAfterLoginGroup
                                                                        .getAssemblyAreaCall
                                                                        .call(
                                                                  building:
                                                                      getJsonField(
                                                                    addressesPermContractorItem,
                                                                    r'''$.building_data.id''',
                                                                  ),
                                                                      ...
                                                                      'latLong':
                                                                        ...
                                                                        functions.convertStringToLatLng(
                                                                            EvacProjAfterLoginGroup.getAssemblyAreaCall
                                                                                .lat(
                                                                                  (_model.apiResultxknCopy?.jsonBody ?? ''),
                                                                                )!
                                                                                .toList(),
                                                                            EvacProjAfterLoginGroup.getAssemblyAreaCall
                                                                                .long(

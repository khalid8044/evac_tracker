...
import 'emergency_contact_list_model.dart';
export 'emergency_contact_list_model.dart';

class EmergencyContactListWidget extends StatefulWidget {
  const EmergencyContactListWidget({
    super.key,
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              await launchUrl(Uri(
                                                ...
                                                path: getJsonField(
                                                      widget.emergencyContact,
                                                      r'''$.nearest_medical_center_contact''',
                                                    ) ??
                                                    "0",
                                              ));
                                            },
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              await launchUrl(Uri(
                                                ...
                                                path: getJsonField(
                                                      widget.emergencyContact,
                                                      r'''$.nearest_medical_hospital_contact''',
                                                    ) ??
                                                    "0",
                                              ));
                                            },

...
import 'evacuation_diagram_all_model.dart';
export 'evacuation_diagram_all_model.dart';

class EvacuationDiagramAllWidget extends StatefulWidget {
  const EvacuationDiagramAllWidget({super.key});

  @override
  State<EvacuationDiagramAllWidget> createState() =>
      _EvacuationDiagramAllWidgetState();
}

class _EvacuationDiagramAllWidgetState
    extends State<EvacuationDiagramAllWidget> {
  late EvacuationDiagramAllModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EvacuationDiagramAllModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      final provider =
          Provider.of<EvacuationDiagramProvider>(context, listen: false);
                      ...
                      child: Material(
                        ...
                        child: SafeArea(
                          child: Container(
                            ...
                            child: Consumer<EvacuationDiagramProvider>(
                                                          ...
                                                          itemBuilder:
                                                            ...
                                                            return Padding(
                                                              ...
                                                              child: InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  provider.getEvacuationDiagramResident(
                                                                      provider.addressesResident[
                                                                          index],
                                                                      context);
                                                                },
                                                          ...
                                                          itemBuilder:
                                                            ...
                                                            return Padding(
                                                              ...
                                                              child: InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  provider.getEvacuationDiagramPermanent(
                                                                      provider.addressesPermContractor[
                                                                          index],
                                                                      context);
                                                                },
